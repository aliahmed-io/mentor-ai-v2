...
function List(props: SlateRenderElementProps) {
  ...
  // Check if this is a paragraph element with listStyleType to avoid hydration errors
  // Paragraph elements with listStyleType should render as div instead of ul/ol
  const isParagraphWithListStyle = props.element.type === "p" && listStyleType;
