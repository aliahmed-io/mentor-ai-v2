      ...
      <div className="space-y-6">
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="mx-auto mt-1 max-w-xl text-sm text-muted-foreground">
                Drop a PDF, PPTX, DOCX, TXT or an image. Text will be extracted
                and used as context for the chatbot.
              </p>
              <div className="mx-auto mt-4 max-w-xl">
                <UploadForm onUploaded={handleUploaded} />
              </div>
              <p className="mt-3 text-xs text-muted-foreground">
                Tip: Large files may be truncated; for long documents we
                recommend RAG/chunking
              </p>
            </CardContent>
          </Card>
        )}
          ...
          <section className="space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="rounded-md border bg-muted px-3 py-2 text-xs text-muted-foreground">
                ...
                <code className="ml-2 rounded bg-background px-2 py-0.5 text-xs">
                  {sessionId}
                </code>
              </div>
            ...
            {filePreview && (
              <div className="rounded-md border bg-card p-3">
                <div className="text-sm font-medium text-foreground">
                  Document excerpt (first 1k chars)
                </div>
        ...
        <footer className="rounded-md border p-4 text-xs text-muted-foreground">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              In-memory sessions — restart loses data. Use Redis for
              persistence.
            </li>
            <li>
              OCR on images uses tesseract.js; it can be slow for many images.
            </li>
            <li>
              I can add chunking + vector store (Milvus/Weaviate/Redis) for long
              docs.
            </li>
          </ul>
        </footer>
